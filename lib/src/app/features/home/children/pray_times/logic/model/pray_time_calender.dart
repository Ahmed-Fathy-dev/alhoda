...
part 'pray_time_calender.g.dart';

@JsonSerializable(createToJson: false)
class CalenderMRes extends Equatable {
  const CalenderMRes({
    required this.code,
  ...
  final List<PrayCalenderModel>? data;

  factory CalenderMRes.fromJson(Map<String, dynamic> json) =>
      _$CalenderMResFromJson(json);
...
@JsonSerializable(createToJson: false)
class PrayCalenderModel extends Equatable {
  const PrayCalenderModel({
  ...
  factory PrayCalenderModel.fromJson(Map<String, dynamic> json) =>
      _$PrayCalenderModelFromJson(json);
